...
if (isset($_POST["submit"])) {
   ...
   $sql = "INSERT INTO `admin`(`id`, `name`, `email`, `password_hash`) VALUES (NULL,'$first_name','$email','$password')";

   $result = mysqli_query($mysqli, $sql);

   if ($result) {
      header("Location: adm-in.php?msg=nuevo usuario creado");
   } else {
      ...
      <div class="container d-flex justify-content-center">
         <form action="" method="post" style="width:50vw; min-width:300px;">
            ...
            <div class="mb-3">
               ...
               <input type="text" class="form-control" name="password_hash" placeholder="">
            </div>
               </div>
